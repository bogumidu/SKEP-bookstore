<template>
  <Wrapper ref="wrapper">
    ...
    <v-row>
      <v-col v-for="(book, index) in comedy" v-bind:key="index" cols="2">
        <v-card
            class="mx-auto"
        >
          <v-img
    ...
    <v-row>
      <v-col v-for="(book, index) in drama" v-bind:key="index" cols="2">
        <v-card
            class="mx-auto"
        >
          <v-img
    ...
    <v-row>
      <v-col v-for="(book, index) in action" v-bind:key="index" cols="2">
        <v-card
            class="mx-auto"
        >
          <v-img
